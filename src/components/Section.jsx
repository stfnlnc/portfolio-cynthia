        ...
        return (
            <>
                <section {...props} className="section relative w-full h-[100lvh]">
                    {src &&
                        <a data-name={name} data-category={category} className="snap-image group absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[70lvh]" href={href}>
                            <img className="relative w-full h-full object-center object-cover" src={src} alt=""/>
