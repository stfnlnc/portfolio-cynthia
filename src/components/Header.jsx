...
export default function Header() {
    ...
    return (
        <>
            <div className="fixed top-0 left-0 grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 xl:grid-cols-12 gap-5 px-5 py-4 z-150 w-full border-t border-light md:border-none">
                <div className="hidden md:flex flex-row items-start justify-start gap-1 px-1 col-span-1 md:col-span-2 select-none">
                    <WorldIcon/>
                    <div className="uppercase flex flex-row gap-2">
                        <div className="swipe-hover">PARIS</div>
                        {formatTime(time)}</div>
                </div>
                <div className="uppercase flex flex-col gap-0 col-span-4 md:col-span-3 xl:col-span-5 px-1 select-none">
                ...
                <div className="uppercase col-span-4 md:col-span-3 lg:col-span-2 px-1 select-none fixed bottom-5 left-5 lg:relative lg:bottom-auto lg:left-auto">
